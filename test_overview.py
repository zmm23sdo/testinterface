...
def test_getNewDealerCount():
    getNewDealerCount = inter.getNewDealerCount(
        startTime = "2021-08-22T16:00:00.000Z", 
        endTime = "2021-08-29T15:59:59.999Z", 
        interval = "86400", 
        headers = headers
    )
    print("-"*100)
    print("获取新增dealer返回：",getNewDealerCount.json())
    print("-"*100)
    assert getNewDealerCount.json()['success'] == True
# #2.获取dealer新增统计数据
def test_getNewDealerStatics():
    getNewDealerStatics = inter.getNewDealerStatics(
        dayStart = "2021-08-24T16:00:00.000Z", 
        dayEnd = "2021-08-25T15:59:59.999Z", 
        weekStart = "2021-08-22T16:00:00.000Z", 
        weekEnd = "2021-08-29T15:59:59.999Z", 
        monthStart = "2021-07-31T16:00:00.000Z", 
        monthEnd = "2021-08-31T15:59:59.999Z", 
        lastWeekStart = "2021-08-15T16:00:00.000Z", 
        lastWeekEnd = "2021-08-22T15:59:59.999Z", 
        lastMonthStart = "2021-06-30T16:00:00.000Z", 
        lastMonthEnd = "2021-07-31T15:59:59.999Z", 
        headers = headers
    )
    print("-"*100)
    print("获取dealer新增统计数据返回：",getNewDealerStatics.json())
    print("-"*100)
    assert getNewDealerStatics.json()['success'] == True
# #3.获取新增seller
def test_getNewSellerCount():
    ...
    print("-"*100)
    print("获取新增seller返回：",getNewSellerCount.json())
    print("-"*100)
    assert getNewSellerCount.json()['success'] == True
# #4.获取seller新增统计数据
def test_getNewSellerStatics():
    ...
    print("-"*100)
    print("获取seller新增统计数据返回：",getNewSellerStatics.json())
    print("-"*100)
    assert getNewSellerStatics.json()['success'] == True
# #5.获取新增SalesAgent
def test_getNewSalesAgentCount():
    ...
    print("-"*100)
    print("获取新增SalesAgent返回：",getNewSalesAgentCount.json())
    print("-"*100)
    assert getNewSalesAgentCount.json()['success'] == True
...
def test_getNewSalesAgentStatics():
    ...
    print("-"*100)
    print("获取SalesAgent新增统计数据返回：",getNewSalesAgentStatics.json())
    print("-"*100)
    assert getNewSalesAgentStatics.json()['success'] == True
# #7.获取统计数据
def test_getStatics():
    ...
    print("-"*100)
    print("获取统计数据返回：",getStatics.json())
    print("-"*100)
    assert getStatics.json()['success'] == True